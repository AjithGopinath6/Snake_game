...
button_min = Button(frame, text='-', height=4, width=9, font=35,
                 command=lambda: button_press('-'))
...
button_clear = Button(frame, text='CLR', height=4, width=9, font=35,
                 command=clear)
button_clear.grid(row=3, column=1)

button_equ = Button(frame, text='=', height=4, width=9, font=35,
                 command=equals)
button_equ.grid(row=3, column=2)
